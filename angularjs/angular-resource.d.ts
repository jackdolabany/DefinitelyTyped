...
declare module ng.resource {
    ...
    interface IResource<T> {
		$get(): ng.IPromise<T>;
        $get(dataOrParams: any): ng.IPromise<T>;
        $get(dataOrParams: any, success: Function): ng.IPromise<T>;
        $get(success: Function, error?: Function): ng.IPromise<T>;
        $get(params: any, data: any, success?: Function, error?: Function): ng.IPromise<T>;
        $save(): ng.IPromise<T>;
        $save(dataOrParams: any): ng.IPromise<T>;
        $save(dataOrParams: any, success: Function): ng.IPromise<T>;
        $save(success: Function, error?: Function): ng.IPromise<T>;
        $save(params: any, data: any, success?: Function, error?: Function): ng.IPromise<T>;
        $query(): ng.IPromise<T[]>;
        $query(dataOrParams: any): ng.IPromise<T[]>;
        $query(dataOrParams: any, success: Function): ng.IPromise<T[]>;
        $query(success: Function, error?: Function): ng.IPromise<T[]>;
        $query(params: any, data: any, success?: Function, error?: Function): ng.IPromise<T[]>;
        $remove(): ng.IPromise<T>;
        $remove(dataOrParams: any): ng.IPromise<T>;
        $remove(dataOrParams: any, success: Function): ng.IPromise<T>;
        $remove(success: Function, error?: Function): ng.IPromise<T>;
        $remove(params: any, data: any, success?: Function, error?: Function): ng.IPromise<T>;
